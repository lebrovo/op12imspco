...
.method constructor <init>(Landroid/content/Context;Landroid/support/v4/media/MediaController2;Landroid/support/v4/media/SessionToken2;Ljava/util/concurrent/Executor;Landroid/support/v4/media/MediaController2$ControllerCallback;)V
    ...
    .line 218
    invoke-virtual {p3}, Landroid/support/v4/media/SessionToken2;->getType()I
...
.method private connectToSession(Landroid/support/v4/media/session/MediaSessionCompat$Token;)V
    ...
    .line 839
    :try_start_1
    iput-object v0, p0, Landroid/support/v4/media/MediaController2ImplLegacy;->mControllerCompat:Landroid/support/v4/media/session/MediaControllerCompat;
    ...
    invoke-direct {v2, p0, v3}, Landroid/support/v4/media/MediaController2ImplLegacy$ControllerCompatCallback;-><init>(Landroid/support/v4/media/MediaController2ImplLegacy;Landroid/support/v4/media/MediaController2ImplLegacy$1;)V
    ...
    .line 841
    iget-object v3, p0, Landroid/support/v4/media/MediaController2ImplLegacy;->mControllerCompat:Landroid/support/v4/media/session/MediaControllerCompat;

    iget-object v4, p0, Landroid/support/v4/media/MediaController2ImplLegacy;->mHandler:Landroid/os/Handler;

    invoke-virtual {v3, v2, v4}, Landroid/support/v4/media/session/MediaControllerCompat;->registerCallback(Landroid/support/v4/media/session/MediaControllerCompat$Callback;Landroid/os/Handler;)V
    ...
    .line 845
    new-instance v1, Landroid/support/v4/media/MediaController2ImplLegacy$3;

    iget-object v2, p0, Landroid/support/v4/media/MediaController2ImplLegacy;->mHandler:Landroid/os/Handler;

    invoke-direct {v1, p0, v2}, Landroid/support/v4/media/MediaController2ImplLegacy$3;-><init>(Landroid/support/v4/media/MediaController2ImplLegacy;Landroid/os/Handler;)V

    const-string v2, "android.support.v4.media.controller.command.CONNECT"

    invoke-direct {p0, v2, v1}, Landroid/support/v4/media/MediaController2ImplLegacy;->sendCommand(Ljava/lang/String;Landroid/os/ResultReceiver;)V
...
.method private sendCommand(ILandroid/os/Bundle;)V
    ...
    const-string v1, "android.support.v4.media.controller.command.BY_COMMAND_CODE"

    invoke-direct {p0, v1, p2, v0}, Landroid/support/v4/media/MediaController2ImplLegacy;->sendCommand(Ljava/lang/String;Landroid/os/Bundle;Landroid/os/ResultReceiver;)V
...
.method private sendCommand(Ljava/lang/String;Landroid/os/Bundle;Landroid/os/ResultReceiver;)V
    ...
    :try_start_1
    iget-object v1, p0, Landroid/support/v4/media/MediaController2ImplLegacy;->mControllerCompatCallback:Landroid/support/v4/media/MediaController2ImplLegacy$ControllerCompatCallback;
    :try_end_1
    .catchall {:try_start_1 .. :try_end_1} :catchall_0
    ...
    .line 913
    const-string v3, "android.support.v4.media.argument.ICONTROLLER_CALLBACK"

    invoke-static {p2, v3, v0}, Landroid/support/v4/app/BundleCompat;->putBinder(Landroid/os/Bundle;Ljava/lang/String;Landroid/os/IBinder;)V
    ...
    const-string v3, "android.support.v4.media.argument.PACKAGE_NAME"
    ...
    const-string v3, "android.support.v4.media.argument.UID"
    ...
    .restart local v1    # "callback":Landroid/support/v4/media/MediaController2ImplLegacy$ControllerCompatCallback;
    .restart local v2    # "controller":Landroid/support/v4/media/session/MediaControllerCompat;
    :goto_0
    :try_start_3
    monitor-exit v0
    :try_end_3
...
.method onConnectedNotLocked(Landroid/os/Bundle;)V
    ...
    const-string v11, "MC2ImplLegacy"
    ...
    .end local v2    # "currentMediaItem":Landroid/support/v4/media/MediaItem2;
    .end local v3    # "bufferingState":I
    .end local v4    # "playbackStateCompat":Landroid/support/v4/media/session/PlaybackStateCompat;
    .end local v5    # "repeatMode":I
    .end local v6    # "shuffleMode":I
    .end local v7    # "playlist":Ljava/util/List;, "Ljava/util/List<Landroid/support/v4/media/MediaItem2;>;"
    .end local v8    # "playbackInfo":Landroid/support/v4/media/MediaController2$PlaybackInfo;
    .end local v9    # "metadata":Landroid/support/v4/media/MediaMetadata2;
    .end local v10    # "close":Z
    .end local p0    # "this":Landroid/support/v4/media/MediaController2ImplLegacy;
    ...
    .line 823
    .restart local v0    # "allowedCommands":Landroid/support/v4/media/SessionCommandGroup2;
    .restart local v1    # "playerState":I
    .restart local v2    # "currentMediaItem":Landroid/support/v4/media/MediaItem2;
    .restart local v3    # "bufferingState":I
    .restart local v4    # "playbackStateCompat":Landroid/support/v4/media/session/PlaybackStateCompat;
    .restart local v5    # "repeatMode":I
    .restart local v6    # "shuffleMode":I
    .restart local v7    # "playlist":Ljava/util/List;, "Ljava/util/List<Landroid/support/v4/media/MediaItem2;>;"
    .restart local v8    # "playbackInfo":Landroid/support/v4/media/MediaController2$PlaybackInfo;
    .restart local v9    # "metadata":Landroid/support/v4/media/MediaMetadata2;
    .restart local v10    # "close":Z
    .restart local p0    # "this":Landroid/support/v4/media/MediaController2ImplLegacy;
...
.method public setPlaylist(Ljava/util/List;Landroid/support/v4/media/MediaMetadata2;)V
    ...
    .line 626
    const-string v2, "android.support.v4.media.argument.PLAYLIST"
    ...
    :goto_0
    const-string v2, "android.support.v4.media.argument.PLAYLIST_METADATA"
