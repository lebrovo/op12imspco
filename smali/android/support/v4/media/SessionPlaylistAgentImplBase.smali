...
.method constructor <init>(Landroid/support/v4/media/MediaSession2ImplBase;Landroid/support/v4/media/BaseMediaPlayer;)V
    ...
    invoke-direct {v0, p0, v1, v2}, Landroid/support/v4/media/SessionPlaylistAgentImplBase$PlayItem;-><init>(Landroid/support/v4/media/SessionPlaylistAgentImplBase;ILandroid/support/v4/media/DataSourceDesc;)V
    ...
    invoke-direct {v0, p0, v2}, Landroid/support/v4/media/SessionPlaylistAgentImplBase$MyPlayerEventCallback;-><init>(Landroid/support/v4/media/SessionPlaylistAgentImplBase;Landroid/support/v4/media/SessionPlaylistAgentImplBase$1;)V
...
.method private getNextValidPlayItemLocked(II)Landroid/support/v4/media/SessionPlaylistAgentImplBase$PlayItem;
    ...
    .line 456
    :cond_2
    iget v3, p0, Landroid/support/v4/media/SessionPlaylistAgentImplBase;->mRepeatMode:I
    ...
    invoke-direct {p0, v2}, Landroid/support/v4/media/SessionPlaylistAgentImplBase;->retrieveDataSourceDescLocked(Landroid/support/v4/media/MediaItem2;)Landroid/support/v4/media/DataSourceDesc;
    ...
    .line 464
    new-instance v3, Landroid/support/v4/media/SessionPlaylistAgentImplBase$PlayItem;

    invoke-direct {v3, p0, p1, v2}, Landroid/support/v4/media/SessionPlaylistAgentImplBase$PlayItem;-><init>(Landroid/support/v4/media/SessionPlaylistAgentImplBase;ILandroid/support/v4/media/DataSourceDesc;)V
...
.method private updateCurrentIfNeededLocked()V
    ...
    iget v4, v1, Landroid/support/v4/media/SessionPlaylistAgentImplBase$PlayItem;->shuffledIdx:I
