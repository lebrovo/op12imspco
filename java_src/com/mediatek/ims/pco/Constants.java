...
public final class Constants {
    public static final String ACTION_CARRIER_SIGNAL_PCO_VALUE_DEBUG = "com.mediatek.ims.pco.ui.ACTION_CARRIER_SIGNAL_PCO_VALUE_DEBUG";
    public static final String ACTION_CATEGORY_UI = "com.mediatek.ims.pco.ui.ACTION_CATEGORY_UI";
    public static final String ACTION_QUERY_IMS_PCO_STATUS_FRM_BROWSER = "com.mediatek.ims.pco.ACTION_QUERY_IMS_PCO_STATUS_FRM_BROWSER";
    public static final String ACTION_QUERY_IMS_PCO_STATUS_FRM_CALL = "com.mediatek.ims.pco.ACTION_QUERY_IMS_STATUS_FRM_CALL";
    public static final String ACTION_QUERY_IMS_PCO_STATUS_FRM_NOTIFICATION = "com.mediatek.ims.pco.ACTION_QUERY_IMS_PCO_STATUS_FRM_NOTIFICATION";
    public static final String ACTION_SIGN_UP = "com.mediatek.ims.pco.ui.ACTION_SIGN_UP";
    public static final String ACTION_SIGN_UP_EXIT = "com.mediatek.ims.pco.ui.ACTION_SIGN_UP_EXIT";
    public static final String ACTIVATED = "Activated";
    public static final String CONNECTED = "connected";
    public static final String EXTRA_ACTIVATION_STATUS = "activation-status";
    public static final String EXTRA_NETWORK_TYPE_TO_USE = "preferred-network-type-for-activation";
    public static final String EXTRA_SCREEN_TYPE = "screen-type";
    ...
    public static final String OPERATOR_APPLICATION_SETTING = "com.android.settings.OPERATOR_APPLICATION_SETTING";
    ...
    public static final String SIGNUP_USER_NOTIFICATION_ID = "com.mediatek.ims.pco.ui.SIGNUP_USER_NOTIFICATION_ID";
