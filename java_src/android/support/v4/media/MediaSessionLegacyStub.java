...
public class MediaSessionLegacyStub extends MediaSessionCompat.Callback {
    ...
    private void onCommand2(IBinder caller, int commandCode, Session2Runnable runnable) {
        onCommand2Internal(caller, null, commandCode, runnable);
    }

    private void onCommand2(IBinder caller, SessionCommand2 sessionCommand, Session2Runnable runnable) {
     ...
     */
    /* Code decompiled incorrectly, please refer to instructions dump. */
    private void onCommand2Internal(android.os.IBinder r10, final android.support.v4.media.SessionCommand2 r11, final int r12, final android.support.v4.media.MediaSessionLegacyStub.Session2Runnable r13) {
        /*
            r9 = this;
    ...
    public final class ControllerLegacyCb extends MediaSession2.ControllerCb {
        ...
        ControllerLegacyCb(IMediaControllerCallback callback) {
