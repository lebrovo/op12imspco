...
public class MediaController2ImplLegacy implements MediaController2.SupportLibraryImpl {
    ...
    MediaController2ImplLegacy(Context context, MediaController2 instance, SessionToken2 token, Executor executor, MediaController2.ControllerCallback callback) {
    ...
    public final class ControllerCompatCallback extends MediaControllerCompat.Callback {
        ...
        public void onSessionReady() {
            MediaController2ImplLegacy.this.sendCommand((MediaController2ImplLegacy) "android.support.v4.media.controller.command.CONNECT", (String) new ResultReceiver(MediaController2ImplLegacy.this.mHandler) {
