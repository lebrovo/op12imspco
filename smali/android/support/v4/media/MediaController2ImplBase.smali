...
.method onConnectedNotLocked(Landroid/support/v4/media/IMediaSession2;Landroid/support/v4/media/SessionCommandGroup2;ILandroid/support/v4/media/MediaItem2;JJFJLandroid/support/v4/media/MediaController2$PlaybackInfo;IILjava/util/List;Landroid/app/PendingIntent;)V
    ...
    .end local p0    # "this":Landroid/support/v4/media/MediaController2ImplBase;
    .end local p1    # "sessionBinder":Landroid/support/v4/media/IMediaSession2;
    .end local p2    # "allowedCommands":Landroid/support/v4/media/SessionCommandGroup2;
    .end local p3    # "playerState":I
    .end local p4    # "currentMediaItem":Landroid/support/v4/media/MediaItem2;
    ...
    .end local p12    # "info":Landroid/support/v4/media/MediaController2$PlaybackInfo;
    .end local p13    # "repeatMode":I
    .end local p14    # "shuffleMode":I
    .end local p15    # "playlist":Ljava/util/List;, "Ljava/util/List<Landroid/support/v4/media/MediaItem2;>;"
    ...
    .restart local p0    # "this":Landroid/support/v4/media/MediaController2ImplBase;
    .restart local p1    # "sessionBinder":Landroid/support/v4/media/IMediaSession2;
    .restart local p2    # "allowedCommands":Landroid/support/v4/media/SessionCommandGroup2;
    .restart local p3    # "playerState":I
    .restart local p4    # "currentMediaItem":Landroid/support/v4/media/MediaItem2;
    ...
    .restart local p12    # "info":Landroid/support/v4/media/MediaController2$PlaybackInfo;
    .restart local p13    # "repeatMode":I
    .restart local p14    # "shuffleMode":I
    .restart local p15    # "playlist":Ljava/util/List;, "Ljava/util/List<Landroid/support/v4/media/MediaItem2;>;"
