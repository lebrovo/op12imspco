...
.method public getCurrentMediaItem()Landroid/support/v4/media/MediaItem2;
    ...
    const-string v3, "MS2ImplBase"

    const-string v4, "API calls after the close()"
...
.method notifyToController(Landroid/support/v4/media/MediaSession2$ControllerInfo;Landroid/support/v4/media/MediaSession2ImplBase$NotifyRunnable;)V
    ...
    invoke-virtual {v0, p1}, Landroid/support/v4/media/MediaSession2Stub;->removeControllerInfo(Landroid/support/v4/media/MediaSession2$ControllerInfo;)V
...
.method public updatePlayer(Landroid/support/v4/media/BaseMediaPlayer;Landroid/support/v4/media/MediaPlaylistAgent;Landroid/support/v4/media/VolumeProviderCompat;)V
    ...
    invoke-direct {v7, p0, p1}, Landroid/support/v4/media/SessionPlaylistAgentImplBase;-><init>(Landroid/support/v4/media/MediaSession2ImplBase;Landroid/support/v4/media/BaseMediaPlayer;)V
    ...
    .restart local v2    # "oldAgent":Landroid/support/v4/media/MediaPlaylistAgent;
    goto :goto_3
    ...
    .restart local v3    # "hasPlaybackInfoChanged":Z
    :goto_2
    move-object v5, v2

    .local v5, "oldAgent":Landroid/support/v4/media/MediaPlaylistAgent;
    move-object v9, v5
    ...
    .end local v3    # "hasPlaybackInfoChanged":Z
    .end local v5    # "oldAgent":Landroid/support/v4/media/MediaPlaylistAgent;
    ...
    .restart local v2    # "oldPlayer":Landroid/support/v4/media/BaseMediaPlayer;
    .local v6, "oldAgent":Landroid/support/v4/media/MediaPlaylistAgent;
    move v9, v5
    ...
    .local v3, "hasAgentChanged":Z
    goto :goto_3

    .end local v2    # "oldPlayer":Landroid/support/v4/media/BaseMediaPlayer;
    .end local v3    # "hasAgentChanged":Z
    .end local v4    # "hasPlayerChanged":Z
    .end local v5    # "hasPlaybackInfoChanged":Z
    .end local v6    # "oldAgent":Landroid/support/v4/media/MediaPlaylistAgent;
    :catchall_4
    move-exception v7

    move v4, v3

    .local v4, "hasPlaybackInfoChanged":Z
    move v5, v3

    .local v5, "hasPlayerChanged":Z
    move-object v6, v2

    .restart local v2    # "oldPlayer":Landroid/support/v4/media/BaseMediaPlayer;
    .restart local v6    # "oldAgent":Landroid/support/v4/media/MediaPlaylistAgent;
    move v9, v5
