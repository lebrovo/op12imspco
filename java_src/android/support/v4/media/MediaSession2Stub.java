...
public class MediaSession2Stub extends IMediaSession2.Stub {
    ...
    MediaSession2Stub(MediaSession2.SupportLibraryImpl session) {
        ...
        this.mContext = session.getContext();
    }
    ...
    private void onSessionCommand(IMediaController2 caller, int commandCode, SessionRunnable runnable) {
        onSessionCommandInternal(caller, null, commandCode, runnable);
    }

    private void onSessionCommand(IMediaController2 caller, SessionCommand2 sessionCommand, SessionRunnable runnable) {
     ...
     */
    /* Code decompiled incorrectly, please refer to instructions dump. */
    private void onSessionCommandInternal(android.support.v4.media.IMediaController2 r10, final android.support.v4.media.SessionCommand2 r11, final int r12, final android.support.v4.media.MediaSession2Stub.SessionRunnable r13) {
        /*
            r9 = this;
    ...
    private void onBrowserCommand(IMediaController2 caller, int commandCode, SessionRunnable runnable) {
    ...
    static final class Controller2Cb extends MediaSession2.ControllerCb {
        ...
        Controller2Cb(IMediaController2 callback) {
