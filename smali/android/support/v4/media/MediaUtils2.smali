...
.method static convertMediaItem2ListToParcelableArray(Ljava/util/List;)[Landroid/os/Parcelable;
    ...
    .line 394
    .local v3, "itemBundle":Landroid/os/Parcelable;
    if-eqz v3, :cond_1
    ...
    .line 390
    .end local v2    # "item":Landroid/support/v4/media/MediaItem2;
    .end local v3    # "itemBundle":Landroid/os/Parcelable;
    :cond_1
    add-int/lit8 v1, v1, 0x1
...
.method static convertToMediaMetadata2(Landroid/support/v4/media/MediaDescriptionCompat;)Landroid/support/v4/media/MediaMetadata2;
    ...
    const-string v7, "android.media.metadata.DISPLAY_ICON_URI"

    invoke-virtual {v0, v7, v6}, Landroid/support/v4/media/MediaMetadata2$Builder;->putText(Ljava/lang/String;Ljava/lang/CharSequence;)Landroid/support/v4/media/MediaMetadata2$Builder;
    ...
    invoke-virtual {v0, v9, v8}, Landroid/support/v4/media/MediaMetadata2$Builder;->putText(Ljava/lang/String;Ljava/lang/CharSequence;)Landroid/support/v4/media/MediaMetadata2$Builder;
