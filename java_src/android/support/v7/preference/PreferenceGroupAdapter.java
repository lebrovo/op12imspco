...
public class PreferenceGroupAdapter extends RecyclerView.Adapter<PreferenceViewHolder> implements Preference.OnPreferenceChangeInternalListener, PreferenceGroup.PreferencePositionCallback {
    ...
    public static class PreferenceLayout {
        ...
        public int hashCode() {
            return (((((17 * 31) + this.mResId) * 31) + this.mWidgetResId) * 31) + this.mName.hashCode();
        }
    }
    ...
    private PreferenceGroupAdapter(PreferenceGroup preferenceGroup, Handler handler) {
        ...
        this.mSyncRunnable = new Runnable() {
            /* class android.support.v7.preference.PreferenceGroupAdapter.AnonymousClass1 */
    ...
    private void syncMyPreferences() {
        ...
        if (preferenceManager == null || preferenceManager.getPreferenceComparisonCallback() == null) {
            ...
            DiffUtil.calculateDiff(new DiffUtil.Callback() {
                /* class android.support.v7.preference.PreferenceGroupAdapter.AnonymousClass2 */
    ...
    public int getItemViewType(int position) {
        PreferenceLayout createPreferenceLayout = createPreferenceLayout(getItem(position), this.mTempPreferenceLayout);
        this.mTempPreferenceLayout = createPreferenceLayout;
        int viewType = this.mPreferenceLayouts.indexOf(createPreferenceLayout);
        if (viewType != -1) {
            return viewType;
        }
