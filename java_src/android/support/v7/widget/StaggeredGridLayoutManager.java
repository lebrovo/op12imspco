...
public class StaggeredGridLayoutManager extends RecyclerView.LayoutManager implements RecyclerView.SmoothScroller.ScrollVectorProvider {
    ...
    public void onInitializeAccessibilityNodeInfoForItem(RecyclerView.Recycler recycler, RecyclerView.State state, View host, AccessibilityNodeInfoCompat info) {
        ...
        if (this.mOrientation == 0) {
            ...
            info.setCollectionItemInfo(AccessibilityNodeInfoCompat.CollectionItemInfoCompat.obtain(spanIndex, i, -1, -1, sglp.mFullSpan, DEBUG));
            return;
        }
        ...
        info.setCollectionItemInfo(AccessibilityNodeInfoCompat.CollectionItemInfoCompat.obtain(-1, -1, spanIndex2, i, sglp.mFullSpan, DEBUG));
    }
    ...
    private void setLayoutStateDirection(int direction) {
        ...
        LayoutState layoutState = this.mLayoutState;
        int i = 1;
        if (this.mShouldReverseLayout != (direction == -1 ? true : DEBUG)) {
            i = -1;
        }
    ...
    public View onFocusSearchFailed(View focused, int direction, RecyclerView.Recycler recycler, RecyclerView.State state) {
        ...
        LayoutState layoutState2 = this.mLayoutState;
        boolean shouldSearchFromStart = DEBUG;
    ...
    public class Span {
        ...
        public int findOnePartiallyOrCompletelyVisibleChild(int fromIndex, int toIndex, boolean completelyVisible, boolean acceptCompletelyVisible, boolean acceptEndPointInclusion) {
            ...
            for (int i = fromIndex; i != toIndex; i += next) {
                ...
                boolean childEndInclusion = StaggeredGridLayoutManager.DEBUG;
    ...
    public static class LazySpanLookup {
        ...
        public static class FullSpanItem implements Parcelable {
            ...
            FullSpanItem(Parcel in) {
                ...
                this.mHasUnwantedGapAfter = in.readInt() != 1 ? StaggeredGridLayoutManager.DEBUG : true;
    ...
    public static class SavedState implements Parcelable {
        ...
        SavedState(Parcel in) {
            ...
            this.mReverseLayout = readInt3 == 1;
