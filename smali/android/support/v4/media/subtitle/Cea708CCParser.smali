...
.method private parseC1([BI)I
    ...
    new-instance v14, Landroid/support/v4/media/subtitle/Cea708CCParser$CaptionWindow;
    ...
    invoke-direct {v12, v13, v6}, Landroid/support/v4/media/subtitle/Cea708CCParser$CaptionEvent;-><init>(ILjava/lang/Object;)V

    invoke-direct {v0, v12}, Landroid/support/v4/media/subtitle/Cea708CCParser;->emitCaptionEvent(Landroid/support/v4/media/subtitle/Cea708CCParser$CaptionEvent;)V
    ...
    invoke-direct {v14, v1, v2, v3, v5}, Landroid/support/v4/media/subtitle/Cea708CCParser$CaptionColor;-><init>(IIII)V
    ...
    invoke-direct {v15, v8, v2, v3, v5}, Landroid/support/v4/media/subtitle/Cea708CCParser$CaptionColor;-><init>(IIII)V
    ...
    invoke-direct {v1, v13, v4}, Landroid/support/v4/media/subtitle/Cea708CCParser$CaptionEvent;-><init>(ILjava/lang/Object;)V
    ...
    invoke-direct {v5, v1, v2, v3, v4}, Landroid/support/v4/media/subtitle/Cea708CCParser$CaptionColor;-><init>(IIII)V

    .line 413
    .local v5, "foregroundColor":Landroid/support/v4/media/subtitle/Cea708CCParser$CaptionColor;
    ...
    invoke-direct {v7, v1, v2, v3, v4}, Landroid/support/v4/media/subtitle/Cea708CCParser$CaptionColor;-><init>(IIII)V

    .line 419
    .local v7, "backgroundColor":Landroid/support/v4/media/subtitle/Cea708CCParser$CaptionColor;
    ...
    .line 423
    new-instance v9, Landroid/support/v4/media/subtitle/Cea708CCParser$CaptionColor;

    invoke-direct {v9, v8, v2, v3, v4}, Landroid/support/v4/media/subtitle/Cea708CCParser$CaptionColor;-><init>(IIII)V

    move-object v8, v9

    .line 425
    .local v8, "edgeColor":Landroid/support/v4/media/subtitle/Cea708CCParser$CaptionColor;
    add-int/2addr v6, v12

    .line 426
    new-instance v9, Landroid/support/v4/media/subtitle/Cea708CCParser$CaptionEvent;

    const/16 v10, 0xd

    new-instance v11, Landroid/support/v4/media/subtitle/Cea708CCParser$CaptionPenColor;

    invoke-direct {v11, v5, v7, v8}, Landroid/support/v4/media/subtitle/Cea708CCParser$CaptionPenColor;-><init>(Landroid/support/v4/media/subtitle/Cea708CCParser$CaptionColor;Landroid/support/v4/media/subtitle/Cea708CCParser$CaptionColor;Landroid/support/v4/media/subtitle/Cea708CCParser$CaptionColor;)V

    invoke-direct {v9, v10, v11}, Landroid/support/v4/media/subtitle/Cea708CCParser$CaptionEvent;-><init>(ILjava/lang/Object;)V

    invoke-direct {v0, v9}, Landroid/support/v4/media/subtitle/Cea708CCParser;->emitCaptionEvent(Landroid/support/v4/media/subtitle/Cea708CCParser$CaptionEvent;)V
    ...
    .end local v3    # "green":I
    .end local v4    # "blue":I
    .end local v5    # "foregroundColor":Landroid/support/v4/media/subtitle/Cea708CCParser$CaptionColor;
    .end local v6    # "pos":I
    .end local v7    # "backgroundColor":Landroid/support/v4/media/subtitle/Cea708CCParser$CaptionColor;
    .end local v8    # "edgeColor":Landroid/support/v4/media/subtitle/Cea708CCParser$CaptionColor;
    .restart local p2    # "pos":I
    :pswitch_5
    aget-byte v1, p1, p2
    ...
    new-instance v7, Landroid/support/v4/media/subtitle/Cea708CCParser$CaptionEvent;
    ...
    invoke-direct {v7, v9, v8}, Landroid/support/v4/media/subtitle/Cea708CCParser$CaptionEvent;-><init>(ILjava/lang/Object;)V

    invoke-direct {v0, v7}, Landroid/support/v4/media/subtitle/Cea708CCParser;->emitCaptionEvent(Landroid/support/v4/media/subtitle/Cea708CCParser$CaptionEvent;)V
    ...
    invoke-direct {v1, v3, v2}, Landroid/support/v4/media/subtitle/Cea708CCParser$CaptionEvent;-><init>(ILjava/lang/Object;)V
    ...
    invoke-direct {v4, v3, v5}, Landroid/support/v4/media/subtitle/Cea708CCParser$CaptionEvent;-><init>(ILjava/lang/Object;)V
    ...
    invoke-direct {v3, v7, v4}, Landroid/support/v4/media/subtitle/Cea708CCParser$CaptionEvent;-><init>(ILjava/lang/Object;)V
    ...
    invoke-direct {v2, v11, v3}, Landroid/support/v4/media/subtitle/Cea708CCParser$CaptionEvent;-><init>(ILjava/lang/Object;)V
